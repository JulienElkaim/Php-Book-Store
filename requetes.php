...
<?php
	...
	if(!isset($_POST["queryChoiceIndex"])){
		...
		if(isset($_SESSION['queryChoiceIndex'])){
			$_POST["queryChoiceIndex"] = $_SESSION['queryChoiceIndex'];
		}

	}else{
		$_SESSION['queryChoiceIndex'] = $_POST["queryChoiceIndex"];
	}
?>
...
<table class="InsertInterfaces" cellspacing="10">
	<tr>
		<?php 
				...
				{
					echo '<tr>';
					echo '<h2> Résultat de la requête: #' . $_POST["queryChoiceIndex"];
					echo '</tr>';
					echo '<tr>';
					include ("cmp/requetedisplayerQUERIES.php");
					echo '</tr>';
					/*
